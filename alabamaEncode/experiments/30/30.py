...
if __name__ == "__main__":
    ...
    config = EncoderConfigObject(
        vmaf=96,
        video_filters="crop=3808:1744:28:208,scale=-2:1080:flags=lanczos,zscale=t=linear:npl=100,format=gbrpf32le,zscale=p=bt709,tonemap=tonemap=reinhard:desat=0,zscale=t=bt709:m=bt709:r=tv",
