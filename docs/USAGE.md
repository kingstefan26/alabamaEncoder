...
| `--flag1` | Find what CRF matches the configured bitrate, encode at that CRF, and redo if the CRF bitrate is higher than set |
...
| `--dont_calc_final_vmaf` | Don't calculate final VMAF |
