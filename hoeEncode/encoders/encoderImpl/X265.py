...
class AbstractEncoderX265(AbstractEncoder):
    ...
    def get_encode_commands(self) -> List[str]:
        ...
        kommand = f'ffmpeg -y {self.chunk.get_ss_ffmpeg_command_pair()} -c:v libx265 -vf {self.crop_string} ' \
        ...
        def get_param_thing(pass_i=-1):
            ...
            return ' -x265-params "rd=6 rdoq-level=2 psy-rdoq=1 rskip=0 limit-refs=0 tu-intra-depth=4 tu-inter-depth=4' \
        ...
        if self.passes == 2:
            ...
            return [
                f'{kommand} {get_param_thing()} {self.output_path}'
            ]
