...
from hoeEncode.ConvexHullEncoding.tests.TestUtil import get_test_scenes, path_setup
...
from hoeEncode.encode.ffmpeg.FfmpegUtil import EncoderConfigObject, EncoderJob, VideoConcatenator
...
if __name__ == '__main__':
    ...
    scenes = get_test_scenes(input_file, '/home/kokoniara/dev/VideoSplit/hoeEncode/ConvexHullEncoding/brinas4e1.json')
