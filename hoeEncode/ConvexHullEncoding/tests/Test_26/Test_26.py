...
from hoeEncode.ConvexHullEncoding.tests.TestUtil import get_test_scenes, get_a_chunk, path_setup
from hoeEncode.encode.encoderImpl.Svtenc import AbstractEncoderSvtenc
from hoeEncode.encode.ffmpeg.FfmpegUtil import EncoderJob, EncoderConfigObject, get_video_ssim, get_video_vmeth, \
    get_total_bitrate
...
if __name__ == '__main__':
    ...
    scenes = get_test_scenes(input_file, '/home/kokoniara/dev/VideoSplit/hoeEncode/ConvexHullEncoding/milfmanorE1.json')
