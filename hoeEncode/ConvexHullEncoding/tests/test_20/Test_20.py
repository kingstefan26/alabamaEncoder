...
if __name__ == '__main__':
    print("Test 20: getting the complexity factor Using vbr with target bitrate instead of crf")
    ...
    enc_control.complexity_rate_estimation(ignore_cache=True)

    job.encoded_scene_path = 'test.ivf'
    print("Running test")
    enc_test = ConvexEncoder(job, config)
    enc_test.complexity_rate_estimation_2(ignore_cache=True)
