...
if __name__ == '__main__':
    ...
    for path in paths:
        ...
        for tune in [1, 0, 2]:
            ...
            if tune == 2:
                svtenc.svt_cli_path = '/home/kokoniara/dev/BlueSwordM-SVT-AV1/Bin/Release/SvtAv1EncApp'
            else:
            ...
            change_from_zero_time = (stats.time_encoding - control_time) / control_time * 100
