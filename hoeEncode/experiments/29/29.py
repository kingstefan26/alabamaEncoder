...
if __name__ == '__main__':
    ...
    #              '/mnt/data/stopmotion.mkv', '/mnt/data/liveAction_4k.mp4']
    paths = ['/mnt/data/liveaction_bright.mkv']
    ...
    for path in paths:
        ...
        if 'liveAction_normal' in path:
            ...
            crope_stringe = 'crop=3808:1744:28:208,zscale=t=linear:npl=100,format=gbrpf32le,zscale=p=bt709,tonemap=tonemap=hable:desat=0,zscale=t=bt709:m=bt709:r=tv'
