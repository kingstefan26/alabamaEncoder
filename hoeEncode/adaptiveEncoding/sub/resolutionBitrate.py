...
def get_resolution_for_bitrate(bitrate: int, chunk_sequence: ChunkSequence, config: EncoderConfig) -> str:
    """
...
def get_bitrate_for_resolution(resolution: str, chunk_sequence: ChunkSequence, config: EncoderConfig) -> int:
    """
